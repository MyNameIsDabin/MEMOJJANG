...
const PATHS: Record<IconName, string> = {
  ...
  /* 오른쪽 아래가 뜯겨 말려 올라간 스티커.
     처음엔 줄이 그어진 종이로 그렸더니 '문서' 로 읽혀서, 글줄을 빼고
     떼어 낸 귀퉁이와 말린 자락만 남겼다 — 그게 스티커를 스티커로 만든다.
     본체 안의 네모는 evenodd 로 뚫려 반짝임이 되고, 말린 자락은 뜯긴 빈자리에 놓여 채워진다. */
  sticker:
    'M2,2h12v8h-4v4h-8zM4,4h3v2h-3zM11,11h3v1h-3zM11,12h2v1h-2zM11,13h1v1h-1z',
