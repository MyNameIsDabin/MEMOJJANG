...
끝없는 캔버스에 원하는 위치로 툭툭 던져놓고, 휠로 확대·축소하면서 씁니다.
...
- **무한 캔버스** — 휠로 확대·축소(커서 기준), 빈 곳을 끌어 이동. 100%·200% 근처에서는 살짝 붙잡아 픽셀이 또렷하게 유지됩니다.
- **노트 네 종류**
...
| `F2` | 고른 노트의 이름 바꾸기 |
| 휠 | 커서 기준 확대·축소 — 단, 내용이 넘쳐 스크롤이 생긴 노트 위에서는 그 안을 굴립니다 |
